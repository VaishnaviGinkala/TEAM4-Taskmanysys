...
//    // Method to handle form submission and update user role
//    @PutMapping("/update/ur/{userroleId}")
//    public String updateUserRole(@PathVariable int userId, @ModelAttribute("updatedUserRole") UserRole updatedUserRole) {
//        boolean updated = userRoleService.updateUserRoleById(userId, updatedUserRole);
//        if (!updated) {
//            throw new UserRoleDoesNotExistsException("User role doesn't exist");
//        }
